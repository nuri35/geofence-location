...
| Touch the worker, partition ownership, dedup, or ack/nack behaviour | `docs/ADR/0016-worker.md` — ack only after commit; the FK-drop catch stays NARROW; prefetch 1 until N5 |
